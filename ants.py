...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while not pos.is_hive():
            if self.min_range <= distance <= self.max_range and pos.bees:
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        if not self.duplicate:
            ...
            pos = self.place.exit
            while pos.exit:
                if pos.ant and not pos.ant.powered_up:
                    pos.ant.damage *= 2
                    pos.ant.powered_up = True
                if pos.ant and pos.ant.is_container() and pos.ant.contained_ant and not pos.ant.contained_ant.powered_up:
                    pos.ant.contained_ant.damage *= 2
                    pos.ant.contained_ant.powered_up = True
                pos = pos.exit
        else:
    ...
    def reduce_health(self, amount):
        ...
        if self.health == 0 and not self.duplicate:
            bees_win() 
